...
void dvbcsa_key_set (const dvbcsa_cw_t cw, struct dvbcsa_key_s *key)
{
  ...
  //printf("LIDVBCSA key: 0x%016lx\n", a);
  dvbcsa_store_le64(key->cw,  a);
  dvbcsa_store_le64(key->cws, ((a & 0xf0f0f0f0f0f0f0f0ULL) >> 4) |
		              ((a & 0x0f0f0f0f0f0f0f0fULL) << 4));
  //printf("LIDVBCSA cws: 0x%016lx\n", ((a & 0xf0f0f0f0f0f0f0f0ULL) >> 4) | ((a & 0x0f0f0f0f0f0f0f0fULL) << 4));
...
void dvbcsa_block_decrypt (const dvbcsa_keys_t key, const dvbcsa_block_t in, dvbcsa_block_t out)
{
  ...
  //printf("LIBDVBCSA W=0x%02x%02x%02x%02x%02x%02x%02x%02x\n", W[0], W[1], W[2], W[3], W[4], W[5], W[6], W[7]);
  ...
  while (i--)
    {
      ...
      //printf("LIBDVBCSA Round Key 0x%02x\n", key[i]);
  ...
  //printf("LIBDVBCSA Block Cipher 0x%02x%02x%02x%02x%02x%02x%02x%02x\n", W[0], W[1], W[2], W[3], W[4], W[5], W[6], W[7]);
