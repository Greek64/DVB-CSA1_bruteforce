...
/**
  ...
  * @throws CapabilityException if FPGA configuration is not supported by the firmware.
  */
    public long configureFpga ( InputStream inputStream, boolean force, int bs ) throws BitstreamReadException, UsbException, BitstreamUploadException, AlreadyConfiguredException, InvalidFirmwareException, CapabilityException {
	try {
...
/**
  ...
  */
	...
	try {
	    return configureFpga( JInputStream.getInputStream( fwFileName ), force, bs );
	}
	catch (IOException e) {
	    throw new BitstreamReadException(e.getLocalizedMessage());
	}
